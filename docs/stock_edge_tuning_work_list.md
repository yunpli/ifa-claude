...
| **T2.3** | G3 Sharpe-like gate | 半天 | 计算 `avg_return / max_drawdown` per horizon；新增 G3 gate：tuned ratio ≥ baseline ratio - 0.05（容差 5%）；artifact 暴露 sharpe-like ratio | none | ✅ done (commit pending) |
